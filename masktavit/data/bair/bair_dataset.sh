...
python masktavit/data/bair/bair_extract_images.py --data_dir ~/.cache/bair
python masktavit/data/bair/bair_image_to_hdf5.py --data_dir ~/.cache/bair --output_dir ${1}
